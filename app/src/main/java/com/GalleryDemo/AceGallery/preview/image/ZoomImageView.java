...
*/
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:               //手指按下事件
                ...
                break;
            case MotionEvent.ACTION_POINTER_DOWN:       //屏幕上已经有两个点按住 再松开一点时触发该事件
            ...
            case MotionEvent.ACTION_MOVE:               //手指移动时触发事件
                ...
                break;
            case MotionEvent.ACTION_POINTER_UP:         //屏幕上已经有两个点按住 再松开一点时触发该事件
                if (event.getPointerCount() == 2) {
                    // 手指离开屏幕时将临时值还原
                    lastXMove = -1;
                    lastYMove = -1;
                ...
                break;
            case MotionEvent.ACTION_UP:                 //手指松开时触发事件
    ...
    protected void onDraw(Canvas canvas) {
        switch (currentStatus) {
            ...
            case STATUS_ZOOM_IN:
                Log.e(TAG, "onDraw: ZOOM" );
                zoom(canvas);
                break;
            case STATUS_MOVE:
                Log.e(TAG, "onDraw: MOVE" );
                move(canvas);
                break;
            case STATUS_INIT:
                Log.e(TAG, "onDraw: INIT" );
                initBitmap(canvas);
                break;
            default:
